...
for i = 1:100
    ...
    leaders = [leaders; ...
        [randn(newLeaderPopulation, length(dancerProps) - 4), ...
        abs(randn(newLeaderPopulation, 1)*0.1 + 1), ...
        randn(newLeaderPopulation, 1) + 10, ...
        (1:newLeaderPopulation)', ...
        zeros(newLeaderPopulation, 1)]];
    followers = [followers; ...
        [randn(newFollowerPopulation, length(dancerProps) - 4), ...
        abs(randn(newFollowerPopulation, 1)*0.1 + 1), ...
        randn(newFollowerPopulation, 1) + 10, ...
        (1:newFollowerPopulation)', ...
        zeros(newFollowerPopulation, 1)]];
